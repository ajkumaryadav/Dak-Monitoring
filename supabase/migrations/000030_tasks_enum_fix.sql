-- Repair partial/failed task module setup (run this if 000029 failed)
-- Drops conflicting enum-based objects and recreates with text status + RLS.

DROP TABLE IF EXISTS public.task_compliance CASCADE;
DROP TABLE IF EXISTS public.task_timeline CASCADE;
